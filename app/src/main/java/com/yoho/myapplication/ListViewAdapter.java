...
public class ListViewAdapter extends RecyclerView.Adapter<ListViewAdapter.CustomListviewHolder> {

Context cxt;
List<ListviewPojo> listView;

    public ListViewAdapter(Context cxt, List<ListviewPojo> listView) {
        this.cxt = cxt;
